var MEMO_2756 = {
  ...
  ug_metrics: {
    ...
    stores_tw_2024oct: 8,         // 2024/10/31 時 8 家
    avg_revenue_per_store_5m: 300, // 5個月平均單店月營收破300萬元
    members: 100000,              // 會員人數破10萬（截至2024年底）
    ai_machine_sec_per_cup: 7,    // AI智能茶飲機平均7秒出一杯
    single_day_record_tw: 2500,   // 台灣單店單日最高2,500杯（2024年底）
    brand_ambassador: "告五人（2025年續任）",
    // 技術優勢
    ai_features: "AI智能茶飲機：IC晶片精控溫度/水流/速度，大數據後台+完整會員系統"
  },
  sharetea: {
    global_total_2024oct: 465,  // 2024/10/31 資料
    us_stores: 169,             // 北美（含加拿大），2024/10/31
    au_stores: 150,             // 大洋洲（澳洲），2024/10/31
    sea_stores: 93,             // 東南亞（新馬印菲），2024/10/31
    hk_stores: 42,              // 香港，2024/10/31
    me_eu_stores: 7,            // 中東+歐洲，2024/10/31
    tw_stores: 4,               // 台灣歇腳亭，2024/10/31
    global_strategy: "北美169家市佔第一（美國30州）；大洋洲150家；香港42家；全球465家跨4大洲12國50城市",
  ...
  other_brands: {
    mamak: {
      ...
      role: "多品牌策略第三支腳；2025年計劃另推新餐食品牌（第四品牌）"
    }
  },
  major_shareholders: {
    insiders_pct: 53.63
